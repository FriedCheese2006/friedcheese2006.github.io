...
pausefriedcheese2006@CheeseWinMachin:~/development/icarus_calc$ ls /mnt/c/Program\ Files\ \(x86\)/Steam/steamapps/common/Icarus/Icarus/Content/
Data  FMOD  Json  Movies  PakMetaHash.json  Paks  Revisions  StringTables  VoxelCache
friedcheese2006@CheeseWinMachin:~/development/icarus_calc$ 